package com.hodur.common.utils.concurrent.threadpool;
...
/**
 * @author Hodur
 * @className ThreadPoolFactoryUtils.java
 * @description 创建ThreadPool工具类
 * @date 2021年04月13日 18:57
 */
@Slf4j
public class ThreadPoolFactoryUtils {
    ...
    public static ExecutorService createCustomThreadPoolIfAbsent(String threadNamePrefix, boolean daemon) {
        CustomThreadPoolConfig customThreadPoolConfig = new CustomThreadPoolConfig();
        return createCustomThreadPoolIfAbsent(customThreadPoolConfig, threadNamePrefix, daemon);
    }
