...
import com.hodur.remote.registry.zk.ZkServiceRegistry;
...
public class ZkServiceRegistryTest {
    ...
    void should_register_service_successful_and_lookup_service_by_service_name() {
        ...
        InetSocketAddress acquiredInetSocketAddress = zkServiceDiscovery.lookupService("com.hodur.remote.registry.zk.ZkServiceRegistry");
